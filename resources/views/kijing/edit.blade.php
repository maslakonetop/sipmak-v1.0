...
<div class="container-fluid">
    <section class="base">
        ...
        @endif
        <h2 class="text-center">Edit Ijin No Ijin {{ $data->kode }} / {{ $data->nobuku_plat }}</h2>
        <h5 class="text-center">A/N {{ $data->nama_pemohon }} untuk Nama Jenazah a/n {{ $data->nama_jenazah }}</h5>
        <hr class="style14">
        <form action="/kijing/{{ $data->id }}" method="post">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="lahir_jenazah" id="lahir_jenazah"
                                ...
                                value="{{ $data->lahir_jenazah }}" required>
                        </div>
                        @error('lahir_jenazah')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="wafat_jenazah" id="wafat_jenazah"
                                ...
                                value="{{ $data->wafat_jenazah }}" required>
                        </div>
                        @error('wafat_jenazah')
                        <div class="invalid-feedback">
                            {{ $message }}
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            <input type="number" name="usia" id="usia"
                                class="form-control @error('usia') is-invalid @enderror" value="{{ $data->usia }}"
                                required>
                        </div>
                    ...
                    <a href="/kijing" class="btn btn-info" style="margin-top: 75px">Kembali</a>
                </div>
                <div class="col-md-6">
                    <div class="form-group row">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="date" name="expired" id="expired"
                                class="form-control @error('expired') is-invalid @enderror" value="{{ $data->expired }}"
                                required>
                        </div>
                        @error('expired')
                        <div class="invalid-feedback">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="text" value="{{ $data->statusijin }}" class="form-control" required>
                        </div>
                        @error('statusijin')
                        <div class="invalid-feedback">
                            {{ $message }}
