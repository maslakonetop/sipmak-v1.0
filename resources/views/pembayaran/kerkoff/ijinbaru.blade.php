...
<div class="container-fluid">
    <section class="base">
        ...
        <hr class="style8">
        <form action="/pembayaran/kijing/bayar" method="GET">
            @csrf
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    {{-- <input type="submit" class="btn btn-outline-info" value="CARI"> --}}
                    <a href="/kijing/create" class="btn btn-outline-success mt-3"><i class="fas fa-plus-circle"></i>
                        Data Baru</a>
                </div>
            </div>
        </form>
            ...
            <table class="table table-hover table-striped table-bordered" style="width: 100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/pemutihan/kijing/form/{{ $row->id }}" class="btn btn-primary"><i
