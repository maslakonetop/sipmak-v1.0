...
<div class="container-fluid">
    <section class="base">
        ...
        <hr class="style14">
        <form action="/pembayaran/karangsuci/update/pemutihan/{{ $data->id }}" method="post">
            @method('PUT')
            @csrf
            <div class="row">
                <div class="col-md-6">
                    ...
                    <a href="/pemutihan/karangsuci/" class="btn btn-info" style="margin-top: 75px"><i
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            {{-- <input type="text" value="" name="statusbayar" id='statusbayar' class="form-control"
                                required> --}}
                        </div>
                    </div>
                    <div class="form-group row">
